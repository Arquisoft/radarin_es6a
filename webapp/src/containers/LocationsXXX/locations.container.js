...
import { LocationsPageContent } from './locations.component';
import { successToaster, errorToaster } from '@utils';

const defaultProfilePhoto = '/img/icon/empty-profile.svg';

/**
 * Container component for the Locations Page, containing example of how to fetch data from a POD
 */
export class LocationsComponent  extends Component<Props> {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    const { webId } = this.props;
    return (
      <LocationsPageContent {...{ name, image, isLoading, webId, updatePhoto: this.updatePhoto }} />
    );
  }
}
